<template>
    ...
    <div class="container py-5">
        <h2 class="mb-4 text-center fw-bold text-primary-emphasis display-6">
                        ...
                        <tr>
                            <th @click="toggleSort('title')" class="sortable">
                                ...
                                <i
                                    v-if="sortKey === 'title'"
                                    :class="
                                        sortAsc ? 'bi bi-caret-up-fill' : 'bi bi-caret-down-fill'
                                    "
                                    class="ms-1"
                                >
                                </i>
                                <i v-else class="bi bi-caret-up bi bi-caret-down text-muted ms-1">
                                </i>
                            </th>
                            <th>Category</th>
                            <th>Downloads</th>
