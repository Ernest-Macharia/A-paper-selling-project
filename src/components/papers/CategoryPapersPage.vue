<template>
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold mb-1 text-gradient-primary">Papers in {{ categoryName }}</h2>
        ...
        <!-- Empty State -->
        <div v-else-if="!allPapers.length" class="card border-0 text-center py-5 empty-state-card">
            <div class="card-body">
