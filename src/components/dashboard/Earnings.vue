<template>
    <div class="container py-5 font-sans">
        <h2 class="mb-4 display-5 fw-bold text-primary-emphasis">My Earnings Dashboard</h2>
            ...
            <div class="col-md-4">
                <div class="card shadow-sm text-white bg-info border-0 rounded-4">
                    <div class="card-body text-center py-4">
                        ...
                        <p class="card-title fs-3 fw-semibold">
        ...
        <div class="table-responsive rounded-4 shadow-sm border">
            ...
            <div
                ...
                class="p-4 text-center text-secondary fst-italic"
            >
