        ...
        <form @submit.prevent="handleUpload" class="p-4 shadow-sm bg-white rounded">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input
                        ...
                        :class="{
                            'is-invalid': submitted && (paper.price === '' || paper.price < 0),
                        }"
                        :disabled="isLoading"
                    />
                    <button
            ...
            >
                ...
                >
                    ...
                    <div
                        v-else
                        class="uploaded-file d-flex align-items-center justify-content-center gap-3"
                    >
                        <div class="file-name text-truncate" style="max-width: 300px">
                            <i
                                :class="`bi ${fileIconClass} me-2`"
                                :title="paper.file.type || 'File'"
                            ></i>
                            {{ paper.file.name }}
                        </div>
                        <button
...
export default {
    ...
    computed: {
        fileIconClass() {
            ...
            if (name.match(/\.(jpg|jpeg|png|gif|bmp|svg)$/))
