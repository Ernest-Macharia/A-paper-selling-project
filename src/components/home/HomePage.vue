<template>
  ...
  <div class="home">
    ...
    <section class="how-it-works-section py-5 bg-light" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="1000">
      <div class="container">
        ...
        <div class="row text-center gy-4">
          <div class="col-md-3">
            <div class="step-card shadow-sm bg-white p-4 rounded-4 h-100">
              ...
              <p class="text-muted small">Create your account in just a few clicks.</p>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="step-card shadow-sm bg-white p-4 rounded-4 h-100">
              ...
              <p class="text-muted small">Share your work and contribute knowledge.</p>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="step-card shadow-sm bg-white p-4 rounded-4 h-100">
              ...
              <p class="text-muted small">Access quality academic resources anytime.</p>
            </div>
          </div>
    ...
    <section class="featured-papers bg-gradient py-5" data-aos="fade-up">
      <div class="container">
        <h2 class="text-center mb-5 fw-bold text-primary-emphasis">Latest Academic Papers</h2>
    ...
    <section class="popular-courses-section py-5" data-aos="fade-up">
      <div class="container">
            ...
            <div class="course-card card text-center h-100 border-0 shadow-sm p-4">
              <div class="card-body d-flex flex-column justify-content-between">
                <div>
                  ...
                  <h5 class="card-title text-dark fw-semibold">{{ course.name }}</h5>
                </div>
        ...
        <div class="text-center mt-4">
          <router-link to="/courses" class="btn btn-outline-primary">Explore All Courses</router-link>
        </div>
      </div>
    </section>
    ...
    <section class="popular-categories-section py-5 bg-light" data-aos="fade-up">
      <div class="container">
        ...
        <div class="text-center mt-4">
          <router-link to="/categories" class="btn btn-outline-primary">Explore All Categories</router-link>
        </div>
      </div>
    </section>
    ...
    <section class="why-us-section py-5 bg-white" data-aos="fade-up">
      <div class="container">
        <div class="text-center mb-5">
          <h2 class="text-center fw-bold text-primary-emphasis mb-5">Why Choose GradesWorld?</h2>
          <p class="lead text-muted">Experience academic access like never before fast, global, and rewarding.</p>
        </div>
        ...
        <div class="row text-center gy-4">
          <div class="col-md-4">
            <div class="why-us-card bg-light p-4 rounded-4 shadow-sm h-100">
              ...
              <p class="text-muted small">Download academic papers instantly without unnecessary steps or friction.</p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="why-us-card bg-light p-4 rounded-4 shadow-sm h-100">
              ...
              <p class="text-muted small">Connect with learners and researchers across the world, sharing knowledge globally.</p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="why-us-card bg-light p-4 rounded-4 shadow-sm h-100">
              ...
              <p class="text-muted small">Earn every time someone downloads your paper, turn your work into income.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="newsletter text-center py-5" data-aos="zoom-in">
      <div class="container">
        ...
        <p class="lead text-muted">Subscribe for updates on new papers, features, and academic opportunities.</p>
        <form class="row justify-content-center mt-4">
          <div class="col-md-6 mb-2 mb-md-0">
            <input type="email" class="form-control form-control-lg newsletter-input" placeholder="Enter your email" required />
          </div>
          <div class="col-md-2">
    ...
    <section class="cta-section text-center py-5" data-aos="slide-up">
      <div class="container">
        <h2 class="fw-bold text-primary-emphasis mb-3">Start Your Journey with GradesHub</h2>
        <p class="text-muted mb-4">Join a thriving academic community of contributors and learners.</p>
        <router-link to="/register" class="btn btn-outline-primary btn-lg px-4">Get Started</router-link>
      </div>
    </section>

    <!-- Get in Touch -->
    <section class="contact-form-section d-flex align-items-center justify-content-center py-5" data-aos="fade-up">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 col-md-8">
            <div class="card p-4 shadow-sm rounded-4">
              <h2 class="text-center text-primary-emphasis mb-4 fw-bold">We would Love to Hear from You</h2>
